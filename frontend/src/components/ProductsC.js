            ...
            <div className='Cgfilter'>
                ...
                <div className='filters'>
                    <ul>
                        ...
                        <Link className='lined' to='?cg=Art'>Art</Link>
                        <Link className='lined' to='?cg=Stationery'>Stationery</Link>
                        <Link className='lined' to='?cg=Office'>Office</Link>
                        <Link className='lined' to='?cg=Craft'>Craft</Link>
                        <Link to='?cg=Best' className='lined'>Best</Link>
                    </ul>
                </div>
            </div>
