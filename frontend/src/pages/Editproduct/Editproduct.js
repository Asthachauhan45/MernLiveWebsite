...
const Editproduct = ({ match, history }) => {
    ...
    const [Bestselected, setBestselected] = useState(false)
                                    ...
                                    <div className="input-div one">
                                        ...
                                        <div className="div">
                                            <Stack direction='column' spacing={4}>
                                                ...
                                                <Stack direction="row">
                                                    <Checkbox onChange={() => { checkboxhandlercg('Art'); setArtselected(!Artselected) }} isChecked={Artselected}>Art  </Checkbox>
                                                    ...
                                                    <Checkbox onChange={() => { checkboxhandlercg('Best'); setBestselected(!Bestselected) }} isChecked={Bestselected}>Best </Checkbox>
                                                    <Checkbox onChange={() => { checkboxhandlercg('Office'); setOfficeselected(!Officeselected) }} isChecked={Officeselected}>Office </Checkbox>
                                                    <Checkbox onChange={() => { checkboxhandlercg('CraftMaterials'); setCraftselected(!Craftselected) }} isChecked={Craftselected}>Craft </Checkbox>
