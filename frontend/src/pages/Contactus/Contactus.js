    ...
    return (
        ...
        <div className="contactUs">
            ...
            <div className="headerContact">
                <Image className="imageContact" src='https://wallpaperaccess.com/full/497097.jpg' alt="contactImage" objectFit="cover" />
                <div className="text">
                    <h2>Contact</h2>
                </div>
                ...
                <div className="showAdrss">
                    ...
                    <div className="box">
                        ...
                        <div className="adressCtn">
                            ...
                            <h3>Lets Talk</h3>
                            <p className="infoCtn">04862789654</p>
                        </div>
                    </div>
                    <div className="box">
                        ...
                        <div className="adressCtn">
                            ...
                            <h3>Sale Support</h3>
                            <p className="infoCtn">TheNotebookShop@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
